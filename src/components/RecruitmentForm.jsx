// RecruitmentForm.jsx
// Full working version with grid styling, modular inputs, and polished layout
...
export default function RecruitmentForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.fullName || !formData.email || !formData.phone) return alert("Full Name, Email, and Phone are required.");
    if (!formData.ndaAgreement) return alert("You must complete the NDA before submitting.");
    ...
    const { photo, yearsCreating, sponsors, camera, ...rest } = formData;
    const cleanedData = {
      ...rest,
    ...
    if (insertError) return alert("Submission failed: " + insertError.message);
